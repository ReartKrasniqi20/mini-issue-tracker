<x-guest-layout>
    ...
    <form method="POST" action="{{ route('login') }}">
        ...
        <div class="block mt-4">
            <label for="remember_me" class="inline-flex items-center">
                <input id="remember_me" type="checkbox" class="rounded border-gray-300 text-gray-900 shadow-sm focus:ring-0" name="remember">
    ...
    @if (Route::has('register'))
        <div class="mt-6 text-center text-sm text-gray-600">
            ...
            <a class="underline text-gray-900 hover:text-gray-700 rounded-md focus:outline-none" href="{{ route('register') }}">
                {{ __('Register') }}
            </a>
        </div>
    @endif
